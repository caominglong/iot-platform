 ...
 */
public class SocketClient2Pool {

    private final Socket socket;

    public SocketClient2Pool(String host, int port) throws IOException {
        // 1、创建socket，并连接服务器
    ...
    public static void main(String[] args) {
        // 端口写死，为8085
        SocketClient2Pool socketMultiClient1 = null;
        try {
            socketMultiClient1 = new SocketClient2Pool(InetAddress.getLocalHost().getHostAddress(), 8085);
